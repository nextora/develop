                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                                    ...
                                                                    <div class="option-payment">
                                                                        <div class="list-left">
                                                                            <div class="custom-control custom-radio">
                                                                                ...
                                                                                <label class="custom-control-label label-payment-option font-600" for="option_<?= $gateway->id; ?>"><?= esc($gateway->name); ?></label>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <li>
                                                                <div class="option-payment">
                                                                    <div class="custom-control custom-radio">
                                                                        ...
                                                                        <label class="custom-control-label label-payment-option font-600" for="option_bank"><?= trans("bank_transfer"); ?><br><small><?= trans("bank_transfer_exp"); ?></small></label>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php endif;
                                                        if (authCheck() && $paymentSettings->cash_on_delivery_enabled && empty($cartHasDigitalProduct) && $mdsPaymentType == 'sale' && $vendorCashOnDelivery == 1 && empty($cartTotal->affiliate_commission)): ?>
                                                            <li>
                                                                <div class="option-payment">
                                                                    <div class="custom-control custom-radio">
                                                                        ...
                                                                        <label class="custom-control-label label-payment-option font-600" for="option_cash_on_delivery"><?= trans("cash_on_delivery"); ?><br><small><?= trans("cash_on_delivery_exp"); ?></small></label>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php endif;
                                                        if (!empty($payWithBalance) && canPayWithBalance($payWithBalance->total, $payWithBalance->currency)): ?>
                                                            <li>
                                                                <div class="option-payment">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" class="custom-control-input" id="option_wallet_balance" name="payment_option" value="wallet_balance" required <?= $i == 0 ? 'checked' : ''; ?>>
                                                                        <label class="custom-control-label label-payment-option font-600" for="option_wallet_balance"><?= trans("wallet_balance"); ?>&nbsp;(<strong class="font-size-13"><?= trans("balance"); ?>:&nbsp;<?= priceFormatted(user()->balance, $payWithBalance->currency, true); ?></strong>)<br><small><?= trans("pay_wallet_balance_exp"); ?></small></label>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php endif; ?>
                                                ...
                                                <div class="form-group m-t-15">
                                                    ...
                                                    <?php endif; ?>
                                                    <button type="submit" name="submit" value="update" class="btn btn-lg btn-custom btn-continue-payment float-right"><?= trans("continue_to_payment") ?>&nbsp;&nbsp;<i class="icon-arrow-right m-0"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
